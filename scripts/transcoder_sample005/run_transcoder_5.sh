...
for model in "${model_lst[@]}"; do
    ...
    # CUDA_VISIBLE_DEVICES=7 bash run_sample005.sh $model cls2summarize
    ...
    CUDA_VISIBLE_DEVICES=4 bash run_sample005.sh $model crossphp
    # CUDA_VISIBLE_DEVICES=1 bash run_sample005.sh $model cross2python
