...
ORIGIN_MODEL_DIR="/wjn/projects/code/CodePrompt/save_models_v2"
#ORIGIN_MODEL_DIR="/wjn/pre-trained-lm/codet5-base/"
...
if [[ ${SUB_TASK} == none ]]; then
  ...
  TOKENIZERS_PARALLELISM=false \
    ...
    --debug 1 --work_dir ${WORKDIR} --meta_task ${META_TASK} --model_name ${MODEL_NAME} --data_num ${DATA_NUM}  --origin_model_dir ${ORIGIN_MODEL_DIR} \
